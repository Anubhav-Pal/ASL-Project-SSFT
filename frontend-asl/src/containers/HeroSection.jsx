  ...
  return (
    <section className="hero_section text-white h-screen flex items-center justify-center">
      <div className="container hero_section-content flex flex-col w-screen py-10 px-28 text-2xl ">
        <div className="nav-links-one  flex items-center justify-between h-1/5 mx-5 lg:mx-0">
        ...
        <div className="z-20 nav-headLine flex flex-col items-center justify-center text-center h-3/5 text-5xl md:text-6xl lg:text-8xl font-bold">
          Transform ideas into <span className="gradient-primary inline">ASL</span>effortlessly
        </div>

        <div className="nav-links-two flex items-center justify-between h-1/5 mx-5 lg:mx-0">

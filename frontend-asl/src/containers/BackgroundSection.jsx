  ...
  return (
    <section className='background absolute -z-50 bg-primry py-40 top-0 w-full '>
      <div className='flex flex-col items-center justify-center container'>
        <div className="overflow-hidden background-heading text-2xl font-semibold text-[#434343] text-center  leading-snug ">
         Powered by Cutting Edge Technology
          <br />
          <span className='text-5xl font-bold gradient-primary pb-10 uppercase'>

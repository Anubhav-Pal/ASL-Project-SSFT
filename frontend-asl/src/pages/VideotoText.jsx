...
const VideoToText = () => (
  <section>
    ...
    <div className="container">
      <div className='text-[#434343] my-5 font-medium opacity-80 mx-5 lg:mx-0'>Upload the video below:</div>
    </div>
    ...
    <div className="container">
      <form
        ...
        <button type="submit" className='bg-primary text-white px-2 py-2 mx-5 lg:mx-0 font-normal w-[8rem] rounded-md mb-5 nav-box transition-all ease-in-out duration-200 hover:bg-[#1e78b9]'>Convert</button>
      </form>
    </div>
